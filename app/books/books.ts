...
export const books: Book[] = [
  {
    ...
    notes:
      "What is happening under the hood? In-depth exploration of React internals and advanced patterns.",
  },
  {
    ...
    notes:
      "Comprehensive guide to profiling and optimizing React applications for better performance.",
  },
];
