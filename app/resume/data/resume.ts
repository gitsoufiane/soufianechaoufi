...
export const resumeData: ExperienceData = {
  ...
  skills: [
    ...
    },
    {
      ...
      items: [
        { name: "Nx", icon: "/tech-stack/nx.svg" }
      ]
    },
    {
      title: "CI/CD",
  ...
  languages: [
    { name: "English", description: "Professional Fluency", icon: "/tech-stack/gb.svg" },
    { name: "French", description: "Professional Fluency", icon: "/tech-stack/fr.svg" },
